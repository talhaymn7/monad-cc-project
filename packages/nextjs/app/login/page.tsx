  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 font-sans p-4">
      <div className="bg-white p-10 rounded-[2rem] shadow-xl w-full max-w-md border border-gray-100 relative">
        ...
        <h1 className="text-4xl font-extrabold text-[#ea004b] mb-2 text-center">Giriş Yap</h1>
        <p className="text-gray-400 text-center mb-8">Kaldığımız yerden devam 🍕</p>
        ...
        <div className="space-y-4">
          ...
          <button
            onClick={() => router.push("/")} // Şimdilik Ana Sayfaya atıyor
        ...
        <div className="mt-6 text-center text-sm text-gray-500">
          Hesabın yok mu?{" "}
          <Link href="/register" className="text-[#ea004b] font-bold hover:underline">
            Kayıt Ol
          </Link>
        </div>
      </div>
